...
- 时干支：用当地时间，因时干支为一日之阴阳四时八节信息，所以要用当地的
- 月干支：除了时差正好跨农历初一，否则可直接用 “月数”，如果跨初一了个人觉得需要校正一下，因为用的是当地的朔望月太阴历
- 年干支：除了时差正好跨农历正月初一，否则可直接用 “年干支”，如果跨初一了个人觉得需要校正一下，因为用的是当地的朔望年太阴历
