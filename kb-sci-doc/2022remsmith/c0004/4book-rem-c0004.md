...
许多人，也被称为“知识分子”，当提到“自由能源”时，他们完全失去了理智，变成了喋喋不休的白痴。该术语已被修改为“从未有过的东西正在被收获，这违反了物理定律”。对于有选择地无知的人来说，这似乎是逃跑的方式。那些选择摩根鼓声的人严重限制了电力的可能性。
...
本文将是一个创造性理解的练习，将更新的知识交给你使用。它是成为一个有用的工具，还是被选择性地忽略，这是你的选择。
...
电子被定义为电能和磁能的实际来源。电子作为粒子，是由J.Thompson教授在20世纪初提出的。现在人们普遍认为电子存在并且是电的来源。当电子被搅动时，它会产生磁能和负电能。今天存在的物理学无法解释为什么电子保持完整，并且不会因其释放的能量而减少。这是摩根和爱迪生阵营提供的固有无知的一部分。
...
一伏特的电子在循环时产生一伏特的电。这可以永远不断地重复，它永远不会耗尽或减少所讨论的电子。他们只是回到他们的空气和/或地球源头，等待一次又一次地做整件事。因此，无论人类走到哪里，电能都是可用的。那些为了利润而干预的人，设定了电能的成本。否则，所有的电能都是免费的，摩根和爱迪生该死。
...
改进汤普森教授的假设，可以看到其他明显的特征来进一步定义电子。它具有由右手和左手旋转产生的磁和电辐射。由于磁性和安培数是一个整体，这表明，处于自然非离子状态的电子以双峰形式存在。当被搅拌推开时，一个旋转并提供电力，另一个旋转以提供磁能（安培数）。当它们重新结合时，我们得到伏特x安培数=瓦特。到目前为止，这个想法在知识库中完全缺失。
...
在特斯拉之前，欧洲有一大群人正在建造用于医疗用途的谐振线圈系统。电流在他们的线圈系统中是危险的。正如将要演示的那样，特斯拉线圈只是其线圈系统电压的一半。在谐振高频线圈系统中活跃的那些（从1860年起）的简短列表包括：居里、伦琴、鲁姆科夫、乌丁、赫兹、莱瓦索尔、杜蒙特、达松瓦尔和许多其他人。
...
法国学院实验医学教授D’Arsonval发明了心电图仪、示波器、安培和伏特表、热成像以及高频电的许多其他医学应用。早在1860年，他就在建造高频线圈系统，并将其用于他的实验工作中。特斯拉的工作与上述人之间有着很强的联系。
...
直到20世纪20年代，各种电动汽车一直占据主导地位，当时电动起动电机使内燃机变得实用。在此之前，在启动时，它经常会打断主人的手臂。那时，电池作为动力源的使用被石油所取代。当权者的地毯下面有一些相当大的块状物。库仑和牛顿的平方反比定律被礼貌地忽略了，它的对立面只被允许具有最抽象的地位。没有对立，我们就没有定义。
...
远程通量读数的源值需要将距离乘以远程读数进行平方，以获得原始值。与此相反，导数与能量等于质量乘以速度常数的平方有关。电等效值，即能量等于电容乘以电压的平方，能量等于感应乘以安培的平方。通量线按照平方定律增加，然后激活以前不属于总和的电子能量。随着接近特斯拉线圈的外端，累积电容和电感增加，这导致输出能量大于存在的输入能量。这种能量是真实的。根据平方反比定律，它可以通过磁通量法和静电伏特计安全地测量
...
如上所述，磁通线由感应亨利电流和电容库仑伏特产生，并定义了电能。该系统的非线性不符合欧姆定律，对于交流系统，欧姆定律被阻抗和电抗所取代。阻抗是系统对交流电流的电阻之和，在谐振时变为零。在共振感应系统中，每秒增加一个周期，就会引发平方定律的第二轮。
...
通量线存在的程度会干扰等量的电子，扰乱环境背景能量，从而获得有用的电能。扰动发生的频率增加了可用的有用能量，并且遵循平方定律。涉及两个平方律分量，即磁通密度和频率。进入谐振，消除电阻效应。
...
只有高于或低于环境水平的电能是有用的。对于美国中部东西走向的地区，在太阳安静的日子里，静电伏特计和通量法估算的环境电压为200000伏。在夜间，环境能量水平降至白天值的一半左右。在太阳活动日，它可能达到太阳平静日的五倍多。在太阳安静的日子里，极地地区的环境背景能量约为50万伏。背景能量随着南北分量和东西连续体的变化而变化。
